...
public class ElevensBoard extends Board {
	...
	public boolean isLegal(List<Integer> selectedCards) {
		...
		if (selectedCards.size() == 2) {
			if(findsPairSum11(selectedCards).size() == 2){
				return true;
			}
	...
	public boolean anotherPlayIsPossible() {
		...
		return findsPairSum11(cIndexes).size() == 2 || findJQK(cIndexes).size() == 3;
	}
	 ...
	 */
	private ArrayList<Integer> findsPairSum11(List<Integer> selectedCards) {
	...
	private ArrayList<Integer> findJQK(List<Integer> selectedCards) {
		...
		boolean foundJack = true;
		boolean foundKing = true;
		boolean foundQueen = true;
	...
	private boolean playPairSum11IfPossible() {
		/* *** TO BE IMPLEMENTED IN ACTIVITY 11 *** */
		  // REPLACE !
		 ArrayList<Integer> cards = findsPairSum11(cardIndexes());
		 if(cards.size() == 2){
	...
	private boolean playJQKIfPossible() {
		/* *** TO BE IMPLEMENTED IN ACTIVITY 11 *** */
		ArrayList<Integer> cards = findJQK(cardIndexes());
		 if(cards.size() == 3){
			replaceSelectedCards(cards);
			return true;
		 }
